...
[Jungo Kasai](https://homes.cs.washington.edu/~jkasai/), [Daniel Friedman](https://danfriedman0.github.io), Robert Frank, [Dragomir Radev](http://www.cs.yale.edu/homes/radev/) and [Owen Rambow](https://owenrambow.com). 2019. [Syntax-aware Neural Semantic Role Labeling with Supertags](https://arxiv.org/abs/1903.05260). In *Proceedings of the Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies (NAACL-HLT)*, Minneapolis.
